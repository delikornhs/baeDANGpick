...
> | 기간 | 형식 | 종목코드 | 파싱 |
> |---|---|---|---|
> | 2009-09 ~ 2019 상반기 | **개별공시** (ETF 1건당 공시 1건, 1,546건) | ❌ 없음 | **불가** |
> | 2019 하반기 ~ 현재 | **일괄공시** (표 형식, 345건) | ✅ ISIN | 가능 |
>
...
- **실제 데이터 보유: 2019-07-31부터** (일괄공시 전환 시점). 분배 이력 7,336건 / 종목 994개
- 이 덕분에 현재 노출 종목의 **87%(160/184)**가 상장이후 전 구간 커버 (backfill 전 36%)
